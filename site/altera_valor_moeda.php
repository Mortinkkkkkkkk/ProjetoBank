<?php
    ...
    // O código a seguir fará com que o valor dá moeda só será alterado quando as páginas ligadas a essa pelo "require_once" recarregarem pelo menos 10 vezes
    // (Não só uma específica e sim qualquer página ligada a essa quando recarregar somará 1 ao contador)
    // Antes de alterar o valor colocará o valor antigo dentro da {
